...
export function Header(props: HeaderProps) {
  ...
  return (
    <header className="fixed -bottom-[30px] md:bottom-[unset] md:top-1/2 left-0 md:left-[unset] md:right-[30px] -translate-y-1/2 z-50 px-4 py-2 md:py-0 md:px-0 drop-shadow-md shadow-white-dark bg-white w-full md:w-auto md:bg-opacity-0 md:drop-shadow-none">
      <nav
        className=""
      >
