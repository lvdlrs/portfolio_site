...
export function MenuItem(props: { label: string; href: string, icon: IconManager }) {
  ...
  return (
      <Link href={props.href} className={`group/linkicon relative size-[50px] block rounded-[50%] duration-300 ${isActive ? "bg-black hover:bg-white hover:text-black" : "bg-grey hover:bg-black hover:text-white"}`}>
